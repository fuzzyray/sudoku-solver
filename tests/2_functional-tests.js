...
suite('Functional Tests', () => {
      ...
      chai.request(server)
        ...
        .end(function(err, res) {
          ...
          assert.property(res.body, 'solution',
            'No solution property in response');
          assert.strictEqual(res.body.solution, output,
            'Output not equal to expected output');
          done();
        });
    });
      ...
      chai.request(server)
        ...
        .end(function(err, res) {
          ...
          assert.deepEqual(res.body, error,
            'error not equal to expected error');
          done();
        });
    });
  ...
  suite('POST to /api/check', () => {
      ...
      chai.request(server)
        ...
        .end(function(err, res) {
          ...
          assert.notProperty(res.body, 'conflict',
            'conflict property in response');
          assert.deepEqual(res.body, status,
            'status not equal to expected status');
          done();
        });
    });
        ...
        chai.request(server)
          ...
          .end(function(err, res) {
            ...
            assert.property(res.body, 'conflict',
              'conflict property not in response');
            assert.deepEqual(res.body, status,
              'status not equal to expected status');
            done();
          });
    ...
    test(
      'All fields filled in correctly, invalid placement, multiple conflict',
      done => {
        const input = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
        const coordinate = 'A1';
        const value = '1';
    ...
    test('All fields filled in correctly, invalid placement, all conflict',
      done => {
        const input = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
        const coordinate = 'A1';
        const value = '5';
